...
public class DataExporter implements ActionListener, StateHolder {
	...
	public void processAction(ActionEvent event){
		...
		try {
			PDFPlusExporter exporter = new PDFPlusExporter();
            
			if (!"@Page".equals(tableId)) {
			...
			((PDFPlusExporter)exporter).exportPage(context, context.getViewRoot(), outputFileName, encodingType, preProcessor, postProcessor);
