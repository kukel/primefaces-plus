...
public class RowEditFeature implements DataTableFeature {
    ...
    public void encode(FacesContext context, DataTableRenderer renderer, DataTable table) throws IOException {
        ...
        if(table.isRowAvailable()) {
            // 0 added as a last parameter to prevent compilation exceptions.
            // Row editing is not supported in the treedatatable
            renderer.encodeRootRow(context, table, clientId, editedRowId, table.getRowIndexVar(), 0);
        }
    }
